...
- **Gateway route**: `POST /api/v1/tools/research/ehunt/temu/storeQuery` (full URL: `NEXSCOPE_PROXY_BASE + /api/v1/tools/research/ehunt/temu/storeQuery`).
...
- **Route path**: `/api/v1/tools/research/ehunt/temu/storeQuery`
