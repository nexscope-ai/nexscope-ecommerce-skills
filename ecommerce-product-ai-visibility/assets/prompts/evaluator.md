...
6. **Variant attributes do NOT affect product identity.** The following are the SAME product:
   - Different storage/RAM: "iPhone 17 Pro Max 1TB" = "iPhone 17 Pro Max 256GB" = "iPhone 17 Pro Max"
   ...
   - Different size (named): "AirPods Pro Small Tips" = "AirPods Pro"; "Yeti Rambler Large" = "Yeti Rambler"
   - Different capacity/volume: "Stanley Quencher 30 oz" = "Stanley Quencher 40 oz"; "Hydro Flask 32oz" = "Hydro Flask 24oz"
   - Different weight: "Optimum Nutrition Gold Standard 5lb" = "Optimum Nutrition Gold Standard 2lb"
   - Different dimensions: "Samsung Frame TV 55in" = "Samsung Frame TV 65in"
   - Different wattage/power: "Anker 65W Charger" = "Anker 45W Charger" (same product line, different power variant)
   - Different pack quantity: "AmazonBasics Batteries 24-pack" = "AmazonBasics Batteries 8-pack"
   - Different scent/flavor: "Native Deodorant Lavender" = "Native Deodorant Eucalyptus"
   - Different gender: "Nike Air Max 270 Men's" = "Nike Air Max 270 Women's"
   - Different finish: "Hydro Flask Matte Black" = "Hydro Flask Glossy Black"
   - Variant attributes include: colors, storage/RAM, volume/capacity (oz/ml/L), weight (lb/kg/g), dimensions (in/cm), wattage (W), connectivity (WiFi/Cellular/5G/LTE), materials, finishes, scents/flavors, gender, size (S/M/L/XL), pack quantities.
   - If the target product is "Stanley Quencher Travel Tumbler 30 oz" and the AI recommends "Stanley Quencher 40 oz", this IS the same product -> `mentioned: true`, `is_target_product: true`.
   ...
   - IMPORTANT: Model/version/generation are NOT variant attributes. "M4" vs "M5", "Gen 1" vs "Gen 2", "v1" vs "v2", "iPhone 17" vs "iPhone 18", "2024" vs "2025", "Series 9" vs "Series 10" = DIFFERENT products.
   - IMPORTANT: Product line tiers are NOT variant attributes. "Pro" vs "Pro Max", "Air" vs "Pro", "Standard" vs "Ultra", "SE" vs "Plus" = DIFFERENT products.
