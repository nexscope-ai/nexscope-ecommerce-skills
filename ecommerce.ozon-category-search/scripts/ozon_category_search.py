#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/seerfar/ozon/categorySearch.

Usage:
  python ozon_category_search.py '<JSON parameters>'
  python ozon_category_search.py '<JSON parameters>' --inline    # force full stdout output
  python ozon_category_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.ozon-category-search-ozon_category_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/seerfar/ozon/categorySearch'
SLUG = 'ecommerce.ozon-category-search-ozon_category_search'
