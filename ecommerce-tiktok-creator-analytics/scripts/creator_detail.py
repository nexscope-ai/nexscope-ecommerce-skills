#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/kalodata/creator/detail.

Usage:
  python creator_detail.py '<JSON parameters>'
  python creator_detail.py '<JSON parameters>' --inline    # force full stdout output
  python creator_detail.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-tiktok-creator-analytics-creator_detail-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/kalodata/creator/detail'
SLUG = 'ecommerce-tiktok-creator-analytics-creator_detail'
