#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/kalodata/creator/rank.

Usage:
  python creator_rank.py '<JSON parameters>'
  python creator_rank.py '<JSON parameters>' --inline    # force full stdout output
  python creator_rank.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-tiktok-creator-analytics-creator_rank-<timestamp>.json
...
SLUG = 'ecommerce-tiktok-creator-analytics-creator_rank'
