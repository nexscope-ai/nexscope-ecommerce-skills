...
Usage:
  ...
  python text_trademark_detection.py '<JSON parameters>' --inline    # force full stdout output
  python text_trademark_detection.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.text-trademark-detector-text_trademark_detection-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/ruiguan/textTrademarkDetection'
SLUG = 'ecommerce.text-trademark-detector-text_trademark_detection'
