...
if "--help" in _nexscope_help_sys.argv or "-h" in _nexscope_help_sys.argv:
    print('Usage: python maidalv_check_api_flash.py [arguments]')
    raise SystemExit(0)
...
API_PATH = "/api/v1/tools/research/maidalv/checkApiFlash"
SLUG = "nexscope-maidalv-product-tro-detection"
...
def main():
    ...
    if not params.get("mainProductImage"):
        sys.exit("Missing required parameter: mainProductImage")
