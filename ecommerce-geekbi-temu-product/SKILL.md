...
Product search, product detail, site lookup, category lookup, supply price, inventory, sales, revenue, ratings, and recent trend fields.

Public-market research only. It does not access or modify a Temu seller account.
...
| `geekbi_temu_goods_detail.py` | `POST /api/v1/tools/research/geekbi/temu/goodsDetail` |
| `geekbi_temu_goods_search.py` | `POST /api/v1/tools/research/geekbi/temu/goodsSearch` |
