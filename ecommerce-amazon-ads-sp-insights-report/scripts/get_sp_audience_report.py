#!/usr/bin/env python3
"""
SP Audience Report - Nexscope Skill
Call the /api/v1/tools/research/amazonAds/developerProxy endpoint.

Usage:
  python get_sp_audience_report.py '<JSON parameters>'           # Automatic: print small results in full; save large results and print a summary
  python get_sp_audience_report.py '<JSON parameters>' --inline  # Force full output to stdout
  python get_sp_audience_report.py '<JSON parameters>' --no-cache # Bypass the 24h cache of successful results
