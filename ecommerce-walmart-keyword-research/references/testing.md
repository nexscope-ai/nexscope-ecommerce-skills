...
- Compile `scripts/sorftime_walmart_keyword_research.py` with Python.
...
- External Curl did not expose upstream billing headers; backend monitoring `response.headers` supplied array-valued evidence. `X-Cost-Token=15000`, calculated credits `15.615`, reported `X-Cost-Credit=8`, trace `376dc7f4c32d96c79193df987edba317`. Do not substitute body `costToken`.
