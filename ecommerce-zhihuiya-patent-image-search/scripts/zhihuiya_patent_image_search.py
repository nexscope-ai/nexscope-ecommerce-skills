#!/usr/bin/env python3
"""Standard-library proxy client for /zhihuiya/patentImageSearch (design patents).

Usage:
  python zhihuiya_patent_image_search.py '<JSON parameters>'
  python zhihuiya_patent_image_search.py '<JSON parameters>' --inline    # force full stdout output
  python zhihuiya_patent_image_search.py '<JSON parameters>' --no-cache  # skip local cache
"""
import hashlib
import json
import os
...
SLUG = 'ecommerce-zhihuiya-patent-image-search'
