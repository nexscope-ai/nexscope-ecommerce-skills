...
Usage:
  ...
  python shopify_product_query.py '<JSON parameters>' --inline    # force full stdout output
  python shopify_product_query.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.shopify-product-query-shopify_product_query-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/ehunt/shopify/productQuery'
SLUG = 'ecommerce.shopify-product-query-shopify_product_query'
