#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/zhihuiya/patentForwardCitation.

Usage:
  python patent_references.py '<JSON parameters>'
  python patent_references.py '<JSON parameters>' --inline    # force full stdout output
  python patent_references.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.patent-references-patent_references-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/zhihuiya/patentForwardCitation'
SLUG = 'ecommerce.patent-references-patent_references'
