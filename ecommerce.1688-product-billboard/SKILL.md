...
```json
{"keyWord": "handbags", "proxyRights": "4360897", "buyerProtections": "free shipping, 7-day returns", "sortField": "orderCount", "sortType": "desc"}
```
...
```json
{"keyWord": "toys", "beginOrderCount": 1000, "endPrice": 50, "sortField": "orderCount", "sortType": "desc"}
```
