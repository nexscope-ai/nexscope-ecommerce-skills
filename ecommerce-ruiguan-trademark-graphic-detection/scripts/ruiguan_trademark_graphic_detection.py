#!/usr/bin/env python3
"""Standard-library proxy client for /ruiguan/trademarkGraphicDetection.

Usage:
  python ruiguan_trademark_graphic_detection.py '<JSON parameters>'
  python ruiguan_trademark_graphic_detection.py '<JSON parameters>' --inline    # force full stdout output
  python ruiguan_trademark_graphic_detection.py '<JSON parameters>' --no-cache  # skip local cache
"""
import hashlib
import json
import os
