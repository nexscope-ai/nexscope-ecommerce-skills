#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/wallysmarter/productDetail.

Usage:
  python walmart_product_detail.py '<JSON parameters>'
  python walmart_product_detail.py '<JSON parameters>' --inline    # force full stdout output
  python walmart_product_detail.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-walmart-product-detail-walmart_product_detail-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/wallysmarter/productDetail'
SLUG = 'ecommerce-walmart-product-detail-walmart_product_detail'
