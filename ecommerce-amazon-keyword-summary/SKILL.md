...
- **API Endpoint**: `POST /sif/keywordSummary` (complete params/response/error codes in `references/api.md`)
- **Python Script**: `python scripts/amazon_keyword_summary.py '<JSON params>' [--inline]`
