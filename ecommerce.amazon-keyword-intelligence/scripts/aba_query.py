...
Usage:
  ...
  python aba_query.py '<JSON parameters>' --inline    # force full stdout output
  python aba_query.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-keyword-intelligence-aba_query-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/aba/intelligentQuery'
SLUG = 'ecommerce.amazon-keyword-intelligence-aba_query'
