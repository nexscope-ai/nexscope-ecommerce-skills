#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/mpstats/ozon/categoryProducts.

Usage:
  python ozon_category_products.py '<JSON parameters>'
  python ozon_category_products.py '<JSON parameters>' --inline    # force full stdout output
  python ozon_category_products.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.ozon-category-products-ozon_category_products-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/mpstats/ozon/categoryProducts'
SLUG = 'ecommerce.ozon-category-products-ozon_category_products'
