...
Usage:
  ...
  python amazon_niche_info.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_niche_info.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-niche-info-amazon_niche_info-<timestamp>.json
...
SLUG = 'ecommerce.amazon-niche-info-amazon_niche_info'
