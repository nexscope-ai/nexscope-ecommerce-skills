---
name: ecommerce.product-video-generator-api
version: 1.0.0
category: ecommerce
description: Generate video asynchronously from one image or controlled first and last frames. Use this skill when the user asks for this exact ecommerce workflow, analysis, data lookup, or deliverable.
---

# Product Video Generator Api
