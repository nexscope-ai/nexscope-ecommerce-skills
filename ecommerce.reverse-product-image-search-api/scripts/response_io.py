...
Usage:
  python scripts/nexscope_io.py run --script <PATH> --out-dir <DIR> '<json_params>' [--label NAME] [--timeout SEC]
  python scripts/nexscope_io.py run --script <PATH> --out-dir <DIR> --params-file <PATH> [--label NAME] [--timeout SEC]
  python scripts/nexscope_io.py read <file> (--path "<JMESPath>" | --fields "f1,f2,...") [--limit N] [--offset M] [--format json|jsonl|csv|table]
...
def _resolve_params(args: argparse.Namespace) -> str:
    ...
    if has_file:
        ...
        # implementationyesimplementation JSON，implementation。
        try:
...
def cmd_run(args: argparse.Namespace) -> int:
    ...
    preview: dict[str, Any] = {
        "_preview": {
            ...
            "warning": (
                ...
                "Use `python scripts/nexscope_io.py read <file> --fields '...'` to extract "
    ...
    preview.update({
        ...
        "next_steps_hint": (
            "use: python scripts/nexscope_io.py read <file> --fields '...' | --path '...'"
        ),
    })
