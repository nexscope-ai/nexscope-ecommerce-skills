...
- **Request URL**: `{NEXSCOPE_PROXY_BASE}/api/v1/tools/research/echotik/listProductVideo`
...
```bash
curl -X POST ${NEXSCOPE_PROXY_BASE}/api/v1/tools/research/echotik/listProductVideo \
