#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/echotik/getVideoDownloadUrl.

Usage:
  python echotik_get_video_download_url.py '<JSON parameters>'
  python echotik_get_video_download_url.py '<JSON parameters>' --inline    # force full stdout output
  python echotik_get_video_download_url.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.tiktok-video-download-url-echotik_get_video_download_url-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/echotik/getVideoDownloadUrl'
SLUG = 'ecommerce.tiktok-video-download-url-echotik_get_video_download_url'
