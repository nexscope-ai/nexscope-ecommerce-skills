#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/dld/productBillboard.

Usage:
  python 1688_product_billboard.py '<JSON parameters>'
  python 1688_product_billboard.py '<JSON parameters>' --inline    # force full stdout output
  python 1688_product_billboard.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-1688-product-billboard-1688_product_billboard-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/dld/productBillboard'
SLUG = 'ecommerce-1688-product-billboard-1688_product_billboard'
