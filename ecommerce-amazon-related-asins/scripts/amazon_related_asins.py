...
Usage:
  ...
  python amazon_related_asins.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_related_asins.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-related-asins-amazon_related_asins-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/jiimore/pageAsinsByAsin'
SLUG = 'ecommerce-amazon-related-asins-amazon_related_asins'
