...
Usage:
  ...
  python web_search.py '<JSON parameters>' --inline    # force full stdout output
  python web_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-web-search-web_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/tsearch/search'
SLUG = 'ecommerce-web-search-web_search'
