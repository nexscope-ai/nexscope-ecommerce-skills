...
- **API Endpoint**: `POST /sif/asinSummary` (complete params/response/error codes in `references/api.md`)
- **Python Script**: `python scripts/amazon_asin_traffic_summary.py '<JSON params>' [--inline]`
