#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/sorftime/amazon/productDetail.

Usage:
  python amazon_market_product_detail.py '<JSON parameters>'
  python amazon_market_product_detail.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_market_product_detail.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-market-product-detail-amazon_market_product_detail-<timestamp>.json
...
SLUG = 'ecommerce-amazon-market-product-detail-amazon_market_product_detail'
