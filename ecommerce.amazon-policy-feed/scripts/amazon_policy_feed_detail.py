...
Usage:
  ...
  python amazon_policy_feed_detail.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_policy_feed_detail.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-policy-feed-amazon_policy_feed_detail-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/amazon/policyFeedDetail'
SLUG = 'ecommerce.amazon-policy-feed-amazon_policy_feed_detail'
