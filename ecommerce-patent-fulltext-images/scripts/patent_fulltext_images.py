...
Usage:
  ...
  python patent_fulltext_images.py '<JSON parameters>' --inline    # force full stdout output
  python patent_fulltext_images.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-patent-fulltext-images-patent_fulltext_images-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/zhihuiya/fulltextImage'
SLUG = 'ecommerce-patent-fulltext-images-patent_fulltext_images'
