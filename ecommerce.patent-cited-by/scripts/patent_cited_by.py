...
Usage:
  ...
  python patent_cited_by.py '<JSON parameters>' --inline    # force full stdout output
  python patent_cited_by.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.patent-cited-by-patent_cited_by-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/zhihuiya/patentCited'
SLUG = 'ecommerce.patent-cited-by-patent_cited_by'
