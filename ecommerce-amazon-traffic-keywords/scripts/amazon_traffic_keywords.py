#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/sellersprite/traffic/keyword.

Usage:
  python amazon_traffic_keywords.py '<JSON parameters>'
  python amazon_traffic_keywords.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_traffic_keywords.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-traffic-keywords-amazon_traffic_keywords-<timestamp>.json
...
SLUG = 'ecommerce-amazon-traffic-keywords-amazon_traffic_keywords'
