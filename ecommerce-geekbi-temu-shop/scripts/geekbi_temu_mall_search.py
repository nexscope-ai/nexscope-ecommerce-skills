...
Call the /api/v1/tools/research/geekbi/temu/mallSearch endpoint.

Usage:
  python geekbi_temu_mall_search.py '<JSON parameters>'
  python geekbi_temu_mall_search.py '<JSON parameters>' --inline
...
API_PATH = "/api/v1/tools/research/geekbi/temu/mallSearch"
SLUG = "ecommerce.geekbi-temu-shop"
...
CONTRACT_JSON = """
{
  ...
  "properties": {
    ...
    "goodsNumMin": {
      "type": "integer",
      "description": "Lower bound for goodsNum; minimum must not exceed maximum.",
      "minimum": 0
    },
    "goodsNumMax": {
      "type": "integer",
      "description": "Upper bound for goodsNum; minimum must not exceed maximum.",
      "minimum": 0
    },
    "followerNumMin": {
      "type": "integer",
      "description": "Lower bound for followerNum; minimum must not exceed maximum.",
      "minimum": 0
    },
    "followerNumMax": {
      "type": "integer",
      "description": "Upper bound for followerNum; minimum must not exceed maximum.",
      "minimum": 0
    },
    "mallSalesMin": {
      "type": "number",
      "description": "Lower bound for mallSales; minimum must not exceed maximum.",
      "minimum": 0
    },
    "mallSalesMax": {
      "type": "number",
      "description": "Upper bound for mallSales; minimum must not exceed maximum.",
      "minimum": 0
    },
    "avgPriceMin": {
      "type": "number",
      "description": "Lower bound for avgPrice; minimum must not exceed maximum.",
      "minimum": 0
    },
    "avgPriceMax": {
      "type": "number",
      "description": "Upper bound for avgPrice; minimum must not exceed maximum.",
      "minimum": 0
    },
    "mallStarMin": {
      "type": "number",
      "description": "Lower bound for mallStar; minimum must not exceed maximum.",
      "minimum": 0,
      "maximum": 5
    },
    "mallStarMax": {
      "type": "number",
      "description": "Upper bound for mallStar; minimum must not exceed maximum.",
      "minimum": 0,
      "maximum": 5
    },
    "mallOpenTimeMin": {
...
def main():
    ...
    if not argv:
        print(
            "Usage: geekbi_temu_mall_search.py '<JSON parameters>' [--inline] [--no-cache]",
            file=sys.stderr,
        )
        sys.exit(1)
