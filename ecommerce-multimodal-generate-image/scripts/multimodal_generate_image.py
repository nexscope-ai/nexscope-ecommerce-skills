#!/usr/bin/env python3
"""Standard-library proxy client for /multimodal/generateImage.

Usage:
  python multimodal_generate_image.py '<JSON parameters>'
  python multimodal_generate_image.py '<JSON parameters>' --inline    # force full stdout output
  python multimodal_generate_image.py '<JSON parameters>' --no-cache  # skip local cache
"""
import hashlib
import json
import os
...
API_PATH = '/api/v1/tools/research/multimodal/generateImage'
SLUG = 'ecommerce-multimodal-generate-image'
