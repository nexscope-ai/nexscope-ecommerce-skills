...
Usage:
  ...
  python amazon_alexa_search.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_alexa_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-alexa-search-amazon_alexa_search-<timestamp>.json
...
SLUG = 'ecommerce-amazon-alexa-search-amazon_alexa_search'
