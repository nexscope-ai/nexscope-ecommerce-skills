#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/mpstats/ozon/productTrend.

Usage:
  python ozon_product_trend.py '<JSON parameters>'
  python ozon_product_trend.py '<JSON parameters>' --inline    # force full stdout output
  python ozon_product_trend.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.ozon-product-trend-ozon_product_trend-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/mpstats/ozon/productTrend'
SLUG = 'ecommerce.ozon-product-trend-ozon_product_trend'
