#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/aiMode/googleSearch.

Usage:
  python google_ai_search.py '<JSON parameters>'
  python google_ai_search.py '<JSON parameters>' --inline    # force full stdout output
  python google_ai_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.google-ai-mode-search-google_ai_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/aiMode/googleSearch'
SLUG = 'ecommerce.google-ai-mode-search-google_ai_search'
