...
Usage:
  ...
  python amazon_market_product_search.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_market_product_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-market-product-search-amazon_market_product_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/sorftime/amazon/productQuery'
SLUG = 'ecommerce.amazon-market-product-search-amazon_market_product_search'
