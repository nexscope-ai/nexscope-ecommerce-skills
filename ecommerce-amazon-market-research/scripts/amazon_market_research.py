#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/sellersprite/market/research.

Usage:
  python amazon_market_research.py '<JSON parameters>'
  python amazon_market_research.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_market_research.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-market-research-amazon_market_research-<timestamp>.json
...
SLUG = 'ecommerce-amazon-market-research-amazon_market_research'
