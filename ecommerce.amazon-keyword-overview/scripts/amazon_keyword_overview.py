#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/sif/keywordOverview.

Usage:
  python amazon_keyword_overview.py '<JSON parameters>'
  python amazon_keyword_overview.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_keyword_overview.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-keyword-overview-amazon_keyword_overview-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/sif/keywordOverview'
SLUG = 'ecommerce.amazon-keyword-overview-amazon_keyword_overview'
