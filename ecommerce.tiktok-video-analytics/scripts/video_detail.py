#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/kalodata/video/detail.

Usage:
  python video_detail.py '<JSON parameters>'
  python video_detail.py '<JSON parameters>' --inline    # force full stdout output
  python video_detail.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.tiktok-video-analytics-video_detail-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/kalodata/video/detail'
SLUG = 'ecommerce.tiktok-video-analytics-video_detail'
