#!/usr/bin/env python3
"""Standard-library proxy client for /ruiguan/gunPartsSearch.

Usage:
  python ruiguan_image_compliance_search.py '<JSON parameters>'
  python ruiguan_image_compliance_search.py '<JSON parameters>' --inline    # force full stdout output
  python ruiguan_image_compliance_search.py '<JSON parameters>' --no-cache  # skip local cache
"""
import hashlib
import json
import os
...
API_PATH = '/api/v1/tools/research/ruiguan/gunPartsSearch'
SLUG = 'ecommerce.ruiguan-gun-parts-search'
