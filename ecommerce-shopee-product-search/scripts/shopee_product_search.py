...
Usage:
  ...
  python shopee_product_search.py '<JSON parameters>' --inline    # force full stdout output
  python shopee_product_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-shopee-product-search-shopee_product_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/youying/shopee/getProductInfos'
SLUG = 'ecommerce-shopee-product-search-shopee_product_search'
