#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/ehunt/temu/productQuery.

Usage:
  python temu_product_source_query.py '<JSON parameters>'
  python temu_product_source_query.py '<JSON parameters>' --inline    # force full stdout output
  python temu_product_source_query.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.temu-product-source-query-temu_product_source_query-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/ehunt/temu/productQuery'
SLUG = 'ecommerce.temu-product-source-query-temu_product_source_query'
