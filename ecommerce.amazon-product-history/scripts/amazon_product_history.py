#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/keepa/productRequest.

Usage:
  python amazon_product_history.py '<JSON parameters>'
  python amazon_product_history.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_product_history.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-product-history-amazon_product_history-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/keepa/productRequest'
SLUG = 'ecommerce.amazon-product-history-amazon_product_history'
