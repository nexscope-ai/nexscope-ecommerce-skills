#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/echotik/batchProductDetail.

Usage:
  python echotik_batch_product_detail.py '<JSON parameters>'
  python echotik_batch_product_detail.py '<JSON parameters>' --inline    # force full stdout output
  python echotik_batch_product_detail.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.tiktok-batch-product-detail-echotik_batch_product_detail-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/echotik/batchProductDetail'
SLUG = 'ecommerce.tiktok-batch-product-detail-echotik_batch_product_detail'
