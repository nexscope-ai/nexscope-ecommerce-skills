...
Usage:
  ...
  python amazon_broad_product_search.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_broad_product_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-broad-product-search-amazon_broad_product_search-<timestamp>.json
...
SLUG = 'ecommerce-amazon-broad-product-search-amazon_broad_product_search'
