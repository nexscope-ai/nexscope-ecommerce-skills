#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/echotik/listNewProductRank.

Usage:
  python echotik_list_new_product_rank.py '<JSON parameters>'
  python echotik_list_new_product_rank.py '<JSON parameters>' --inline    # force full stdout output
  python echotik_list_new_product_rank.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.tiktok-new-product-rank-echotik_list_new_product_rank-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/echotik/listNewProductRank'
SLUG = 'ecommerce.tiktok-new-product-rank-echotik_list_new_product_rank'
