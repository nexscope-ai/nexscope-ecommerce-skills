#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/ehunt/etsy/etsyCategorySearch.

Usage:
  python etsy_category_search.py '<JSON parameters>'
  python etsy_category_search.py '<JSON parameters>' --inline    # force full stdout output
  python etsy_category_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-etsy-category-search-etsy_category_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/ehunt/etsy/etsyCategorySearch'
SLUG = 'ecommerce-etsy-category-search-etsy_category_search'
