#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/zhihuiya/patentFamily.

Usage:
  python patent_family_data.py '<JSON parameters>'
  python patent_family_data.py '<JSON parameters>' --inline    # force full stdout output
  python patent_family_data.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.patent-family-data-patent_family_data-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/zhihuiya/patentFamily'
SLUG = 'ecommerce.patent-family-data-patent_family_data'
