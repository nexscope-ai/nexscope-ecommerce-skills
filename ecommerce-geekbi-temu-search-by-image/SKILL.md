...
4. Run only the selected entry script, for example: `python scripts/geekbi_temu_goods_image_search.py '<JSON parameters>' --no-cache` when the script supports that flag.
