...
Usage:
  ...
  python walmart_search.py '<JSON parameters>' --inline    # force full stdout output
  python walmart_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-walmart-search-walmart_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/walmart/search'
SLUG = 'ecommerce-walmart-search-walmart_search'
