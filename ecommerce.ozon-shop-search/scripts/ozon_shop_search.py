...
Usage:
  ...
  python ozon_shop_search.py '<JSON parameters>' --inline    # force full stdout output
  python ozon_shop_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.ozon-shop-search-ozon_shop_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/seerfar/ozon/shopSearch'
SLUG = 'ecommerce.ozon-shop-search-ozon_shop_search'
