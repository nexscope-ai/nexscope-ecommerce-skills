...
- External Curl did not expose upstream billing headers; backend monitoring `response.headers` supplied array-valued evidence. `X-Cost-Token=0`, calculated credits `0`, reported `X-Cost-Credit=n/a`, trace `41c7b5ca891d6804746c929f1a65017d`. Do not substitute body `costToken`.
