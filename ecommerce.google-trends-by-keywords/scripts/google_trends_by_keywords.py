...
Usage:
  ...
  python google_trends_by_keywords.py '<JSON parameters>' --inline    # force full stdout output
  python google_trends_by_keywords.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.google-trends-by-keywords-google_trends_by_keywords-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/googleTrend/getTrendByKeys'
SLUG = 'ecommerce.google-trends-by-keywords-google_trends_by_keywords'
