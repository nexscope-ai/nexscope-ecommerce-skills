...
Usage:
  ...
  python ebay_search.py '<JSON parameters>' --inline    # force full stdout output
  python ebay_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-ebay-search-ebay_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/ebay/search'
SLUG = 'ecommerce-ebay-search-ebay_search'
