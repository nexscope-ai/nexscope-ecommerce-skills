#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/seerfar/ozon/keywordBackSearch.

Usage:
  python ozon_keyword_back_search.py '<JSON parameters>'
  python ozon_keyword_back_search.py '<JSON parameters>' --inline    # force full stdout output
  python ozon_keyword_back_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.ozon-keyword-back-search-ozon_keyword_back_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/seerfar/ozon/keywordBackSearch'
SLUG = 'ecommerce.ozon-keyword-back-search-ozon_keyword_back_search'
