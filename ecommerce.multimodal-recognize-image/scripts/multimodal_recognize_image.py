#!/usr/bin/env python3
"""Standard-library proxy client for /multimodal/recognizeImage.

Usage:
  python multimodal_recognize_image.py '<JSON parameters>'
  python multimodal_recognize_image.py '<JSON parameters>' --inline    # force full stdout output
  python multimodal_recognize_image.py '<JSON parameters>' --no-cache  # skip local cache
"""
import hashlib
import json
import os
