#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/kalodata/product/detail.

Usage:
  python product_detail.py '<JSON parameters>'
  python product_detail.py '<JSON parameters>' --inline    # force full stdout output
  python product_detail.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.tiktok-product-analytics-product_detail-<timestamp>.json
...
SLUG = 'ecommerce.tiktok-product-analytics-product_detail'
