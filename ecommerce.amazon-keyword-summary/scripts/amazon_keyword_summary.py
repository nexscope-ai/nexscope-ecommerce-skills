...
Usage:
  ...
  python amazon_keyword_summary.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_keyword_summary.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-keyword-summary-amazon_keyword_summary-<timestamp>.json
...
SLUG = 'ecommerce.amazon-keyword-summary-amazon_keyword_summary'
