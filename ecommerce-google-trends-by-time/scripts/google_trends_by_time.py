#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/googleTrend/getTrendByTime.

Usage:
  python google_trends_by_time.py '<JSON parameters>'
  python google_trends_by_time.py '<JSON parameters>' --inline    # force full stdout output
  python google_trends_by_time.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-google-trends-by-time-google_trends_by_time-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/googleTrend/getTrendByTime'
SLUG = 'ecommerce-google-trends-by-time-google_trends_by_time'
