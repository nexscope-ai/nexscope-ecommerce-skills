...
- Compile `scripts/chuhaijiang_video_detail.py` with Python.
- Compile `scripts/chuhaijiang_video_related_products.py` with Python.
- Compile `scripts/chuhaijiang_video_reviews.py` with Python.
- Compile `scripts/chuhaijiang_video_search.py` with Python.
