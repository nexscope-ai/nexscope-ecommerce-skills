#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/kalodata/shop/detail.

Usage:
  python shop_detail.py '<JSON parameters>'
  python shop_detail.py '<JSON parameters>' --inline    # force full stdout output
  python shop_detail.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-tiktok-shop-analytics-shop_detail-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/kalodata/shop/detail'
SLUG = 'ecommerce-tiktok-shop-analytics-shop_detail'
