#!/usr/bin/env python3
"""Standard-library proxy client for /ruiguan/copyrightDetection.

Usage:
  python ruiguan_copyright_detection.py '<JSON parameters>'
  python ruiguan_copyright_detection.py '<JSON parameters>' --inline    # force full stdout output
  python ruiguan_copyright_detection.py '<JSON parameters>' --no-cache  # skip local cache
"""
import hashlib
import json
import os
...
API_PATH = '/api/v1/tools/research/ruiguan/copyrightDetection'
SLUG = 'ecommerce.ruiguan-copyright-detection'
