...
Usage:
  ...
  python amazon_niche_reviews_by_keyword.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_niche_reviews_by_keyword.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-niche-reviews-by-keyword-amazon_niche_reviews_by_keyword-<timestamp>.json
...
SLUG = 'ecommerce-amazon-niche-reviews-by-keyword-amazon_niche_reviews_by_keyword'
