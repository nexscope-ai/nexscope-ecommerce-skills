#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/zhihuiya/abstractImage.

Usage:
  python patent_abstract_image_data.py '<JSON parameters>'
  python patent_abstract_image_data.py '<JSON parameters>' --inline    # force full stdout output
  python patent_abstract_image_data.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.patent-abstract-image-data-patent_abstract_image_data-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/zhihuiya/abstractImage'
SLUG = 'ecommerce.patent-abstract-image-data-patent_abstract_image_data'
