#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/zhihuiya/claimDataTranslated.

Usage:
  python patent_claims_translation.py '<JSON parameters>'
  python patent_claims_translation.py '<JSON parameters>' --inline    # force full stdout output
  python patent_claims_translation.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.patent-claims-translation-patent_claims_translation-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/zhihuiya/claimDataTranslated'
SLUG = 'ecommerce.patent-claims-translation-patent_claims_translation'
