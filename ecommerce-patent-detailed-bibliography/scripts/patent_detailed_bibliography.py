#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/zhihuiya/bibliography.

Usage:
  python patent_detailed_bibliography.py '<JSON parameters>'
  python patent_detailed_bibliography.py '<JSON parameters>' --inline    # force full stdout output
  python patent_detailed_bibliography.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-patent-detailed-bibliography-patent_detailed_bibliography-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/zhihuiya/bibliography'
SLUG = 'ecommerce-patent-detailed-bibliography-patent_detailed_bibliography'
