...
Category opportunity discovery, keyword-demand research, site lookup, category trees, filters, and daily, weekly, or monthly trends.

Public-market research only. It does not access a Temu seller account or perform product, order, advertising, or fulfillment mutations.
...
| `geekbi_temu_category_search.py` | `POST /api/v1/tools/research/geekbi/temu/categorySearch` |
| `geekbi_temu_keyword_search.py` | `POST /api/v1/tools/research/geekbi/temu/keywordSearch` |
