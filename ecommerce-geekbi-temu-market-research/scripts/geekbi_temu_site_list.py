...
Call the /api/v1/tools/research/geekbi/temu/siteList endpoint.

Usage:
  python geekbi_temu_site_list.py '<JSON parameters>'
  python geekbi_temu_site_list.py '<JSON parameters>' --inline
...
API_PATH = "/api/v1/tools/research/geekbi/temu/siteList"
...
def main():
    ...
    if not argv:
        print(
            "Usage: geekbi_temu_site_list.py '<JSON parameters>' [--inline] [--no-cache]",
            file=sys.stderr,
        )
        sys.exit(1)
