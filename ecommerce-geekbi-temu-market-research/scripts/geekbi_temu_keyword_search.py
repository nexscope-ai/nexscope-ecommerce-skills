...
Call the /api/v1/tools/research/geekbi/temu/keywordSearch endpoint.

Usage:
  python geekbi_temu_keyword_search.py '<JSON parameters>'
  python geekbi_temu_keyword_search.py '<JSON parameters>' --inline
...
API_PATH = "/api/v1/tools/research/geekbi/temu/keywordSearch"
SLUG = "ecommerce.geekbi-temu-market-research"
...
CONTRACT_JSON = """
{
  ...
  "properties": {
    ...
    "dsrMin": {
      "type": "number",
      "description": "Lower bound for dsr; minimum must not exceed maximum."
    },
    "dsrMax": {
      "type": "number",
      "description": "Upper bound for dsr; minimum must not exceed maximum."
    },
    "totalSoldMin": {
      "type": "integer",
      "description": "Lower bound for totalSold; minimum must not exceed maximum.",
      "minimum": 0
    },
    "totalSoldMax": {
      "type": "integer",
      "description": "Upper bound for totalSold; minimum must not exceed maximum.",
      "minimum": 0
    },
    "itemCountMin": {
      "type": "integer",
      "description": "Lower bound for itemCount; minimum must not exceed maximum.",
      "minimum": 0
    },
    "itemCountMax": {
      "type": "integer",
      "description": "Upper bound for itemCount; minimum must not exceed maximum.",
      "minimum": 0
    },
    "mallCountMin": {
      "type": "integer",
      "description": "Lower bound for mallCount; minimum must not exceed maximum.",
      "minimum": 0
    },
    "mallCountMax": {
      "type": "integer",
      "description": "Upper bound for mallCount; minimum must not exceed maximum.",
      "minimum": 0
    },
    "avgPriceMin": {
      "type": "number",
    ...
    "totalSalesMin": {
      "type": "number",
      "description": "Lower bound for totalSales; minimum must not exceed maximum.",
      "minimum": 0
    },
    "totalSalesMax": {
      "type": "number",
      "description": "Upper bound for totalSales; minimum must not exceed maximum.",
      "minimum": 0
    },
    "catIds": {
      "type": "array",
    ...
    "firstOnSaleTimeMin": {
      "type": "string",
      "description": "Earliest firstOnSaleTime in ISO-8601 date-time; minimum must not exceed maximum.",
      "maxLength": 40,
      "format": "date-time"
    },
    "firstOnSaleTimeMax": {
      "type": "string",
      "description": "Latest firstOnSaleTime in ISO-8601 date-time; minimum must not exceed maximum.",
      "maxLength": 40,
      "format": "date-time"
    }
  },
...
def main():
    ...
    if not argv:
        print(
            "Usage: geekbi_temu_keyword_search.py '<JSON parameters>' [--inline] [--no-cache]",
            file=sys.stderr,
        )
        sys.exit(1)
