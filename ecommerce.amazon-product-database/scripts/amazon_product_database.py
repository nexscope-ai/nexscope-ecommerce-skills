...
Usage:
  ...
  python amazon_product_database.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_product_database.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-product-database-amazon_product_database-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/tool-jungle-scout/product-database/query'
SLUG = 'ecommerce.amazon-product-database-amazon_product_database'
