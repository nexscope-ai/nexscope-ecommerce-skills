...
if "--help" in _nexscope_help_sys.argv or "-h" in _nexscope_help_sys.argv:
    print('Usage: python zhihuiya_query_search_patent.py [arguments]')
    raise SystemExit(0)
...
API_PATH = "/api/v1/tools/research/zhihuiya/querySearchPatent"
SLUG = "nexscope-zhihuiya-retrieval-patent-search"
