...
- **Gateway route**: `POST /api/v1/tools/research/ehunt/temu/productQuery` (full URL: `NEXSCOPE_PROXY_BASE + /api/v1/tools/research/ehunt/temu/productQuery`).
...
- **Route path**: `/api/v1/tools/research/ehunt/temu/productQuery`
