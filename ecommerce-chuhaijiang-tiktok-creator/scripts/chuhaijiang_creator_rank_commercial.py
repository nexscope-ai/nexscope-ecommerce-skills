#!/usr/bin/env python3
"""
TikTok Commerce Creator Ranking - Nexscope Skill
Call the /api/v1/tools/research/chuhaijiang/creators/rankings/commercial endpoint.

Usage:
  python chuhaijiang_creator_rank_commercial.py '<JSON parameters>'           # Automatic: full small results; save large results and print a summary
  python chuhaijiang_creator_rank_commercial.py '<JSON parameters>' --inline  # Force full output to stdout
...
API_PATH = "/api/v1/tools/research/chuhaijiang/creators/rankings/commercial"
