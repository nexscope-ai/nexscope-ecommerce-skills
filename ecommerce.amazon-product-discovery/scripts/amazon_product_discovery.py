...
Usage:
  ...
  python amazon_product_discovery.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_product_discovery.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-product-discovery-amazon_product_discovery-<timestamp>.json
...
SLUG = 'ecommerce.amazon-product-discovery-amazon_product_discovery'
