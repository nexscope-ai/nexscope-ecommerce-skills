#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/echotik/sellerDetail.

Usage:
  python tiktok_seller_detail.py '<JSON parameters>'
  python tiktok_seller_detail.py '<JSON parameters>' --inline    # force full stdout output
  python tiktok_seller_detail.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-tiktok-seller-detail-tiktok_seller_detail-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/echotik/sellerDetail'
SLUG = 'ecommerce-tiktok-seller-detail-tiktok_seller_detail'
