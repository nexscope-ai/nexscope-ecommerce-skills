#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/seerfar/ozon/keywordMining.

Usage:
  python ozon_keyword_mining.py '<JSON parameters>'
  python ozon_keyword_mining.py '<JSON parameters>' --inline    # force full stdout output
