...
Usage:
  ...
  python product_rank.py '<JSON parameters>' --inline    # force full stdout output
  python product_rank.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-tiktok-product-analytics-product_rank-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/kalodata/product/rank'
SLUG = 'ecommerce-tiktok-product-analytics-product_rank'
