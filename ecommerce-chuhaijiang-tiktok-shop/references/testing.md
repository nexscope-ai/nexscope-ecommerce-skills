...
- Compile `scripts/chuhaijiang_seller_detail.py` with Python.
- Compile `scripts/chuhaijiang_seller_rank_most_promoted.py` with Python.
- Compile `scripts/chuhaijiang_seller_rank_top_selling.py` with Python.
- Compile `scripts/chuhaijiang_seller_related_creators.py` with Python.
- Compile `scripts/chuhaijiang_seller_related_products.py` with Python.
- Compile `scripts/chuhaijiang_seller_related_videos.py` with Python.
- Compile `scripts/chuhaijiang_seller_search.py` with Python.
