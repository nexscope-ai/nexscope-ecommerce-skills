...
Usage:
  ...
  python patent_title_abstract_translation.py '<JSON parameters>' --inline    # force full stdout output
  python patent_title_abstract_translation.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-patent-title-abstract-translation-patent_title_abstract_translation-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/zhihuiya/abstractDataTranslated'
SLUG = 'ecommerce-patent-title-abstract-translation-patent_title_abstract_translation'
