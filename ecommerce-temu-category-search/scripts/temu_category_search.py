...
Usage:
  ...
  python temu_category_search.py '<JSON parameters>' --inline    # force full stdout output
  python temu_category_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-temu-category-search-temu_category_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/ehunt/temu/temuCategorySearch'
SLUG = 'ecommerce-temu-category-search-temu_category_search'
