...
- Compile `scripts/etsy_product_detail.py` with Python.
...
- External Curl did not expose upstream billing headers; backend monitoring `response.headers` supplied array-valued evidence. `X-Cost-Token=10500`, calculated credits `10.9305`, reported `X-Cost-Credit=6`, trace `717ab3cac6051c1c67d57f8a3ed8c651`. Do not substitute body `costToken`.
