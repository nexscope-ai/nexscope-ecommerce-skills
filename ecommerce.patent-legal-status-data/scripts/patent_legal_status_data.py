...
Usage:
  ...
  python patent_legal_status_data.py '<JSON parameters>' --inline    # force full stdout output
  python patent_legal_status_data.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.patent-legal-status-data-patent_legal_status_data-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/zhihuiya/legalStatus'
SLUG = 'ecommerce.patent-legal-status-data-patent_legal_status_data'
