#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/sif/asinKeywords.

Usage:
  python amazon_asin_keywords.py '<JSON parameters>'
  python amazon_asin_keywords.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_asin_keywords.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-asin-keywords-amazon_asin_keywords-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/sif/asinKeywords'
SLUG = 'ecommerce-amazon-asin-keywords-amazon_asin_keywords'
