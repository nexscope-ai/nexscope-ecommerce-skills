...
Usage:
  ...
  python ozon_product_search.py '<JSON parameters>' --inline    # force full stdout output
  python ozon_product_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.ozon-product-search-ozon_product_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/mpstats/ozon/productSearch'
SLUG = 'ecommerce.ozon-product-search-ozon_product_search'
