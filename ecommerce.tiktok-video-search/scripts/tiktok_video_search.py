...
Usage:
  ...
  python tiktok_video_search.py '<JSON parameters>' --inline    # force full stdout output
  python tiktok_video_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.tiktok-video-search-tiktok_video_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/echotik/listVideo'
SLUG = 'ecommerce.tiktok-video-search-tiktok_video_search'
