#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/tool-jungle-scout/keywords/by-keyword.

Usage:
  python amazon_keyword_expansion.py '<JSON parameters>'
  python amazon_keyword_expansion.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_keyword_expansion.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-keyword-expansion-amazon_keyword_expansion-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/tool-jungle-scout/keywords/by-keyword'
SLUG = 'ecommerce.amazon-keyword-expansion-amazon_keyword_expansion'
