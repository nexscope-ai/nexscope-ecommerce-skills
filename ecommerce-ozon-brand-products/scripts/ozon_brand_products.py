#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/mpstats/ozon/brandProducts.

Usage:
  python ozon_brand_products.py '<JSON parameters>'
  python ozon_brand_products.py '<JSON parameters>' --inline    # force full stdout output
  python ozon_brand_products.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-ozon-brand-products-ozon_brand_products-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/mpstats/ozon/brandProducts'
SLUG = 'ecommerce-ozon-brand-products-ozon_brand_products'
