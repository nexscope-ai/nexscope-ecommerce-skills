#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/seerfar/ozon/marketKeywordSearch.

Usage:
  python ozon_market_keyword_search.py '<JSON parameters>'
  python ozon_market_keyword_search.py '<JSON parameters>' --inline    # force full stdout output
  python ozon_market_keyword_search.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-ozon-market-keyword-search-ozon_market_keyword_search-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/seerfar/ozon/marketKeywordSearch'
SLUG = 'ecommerce-ozon-market-keyword-search-ozon_market_keyword_search'
