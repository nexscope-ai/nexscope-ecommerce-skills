#!/usr/bin/env python3
"""Standard-library proxy client for /zhihuiya/patentImageSearch (utility model patents).

Usage:
  python zhihuiya_utility_patent_image_search.py '<JSON parameters>'
  python zhihuiya_utility_patent_image_search.py '<JSON parameters>' --inline    # force full stdout output
  python zhihuiya_utility_patent_image_search.py '<JSON parameters>' --no-cache  # skip local cache
"""
import hashlib
import json
import os
...
API_PATH = '/api/v1/tools/research/zhihuiya/patentImageSearch'
SLUG = 'ecommerce.zhihuiya-utility-patent-image-search'
