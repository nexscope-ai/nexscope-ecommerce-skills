...
- Compile `scripts/chuhaijiang_live_detail.py` with Python.
- Compile `scripts/chuhaijiang_live_related_products.py` with Python.
- Compile `scripts/chuhaijiang_live_search.py` with Python.
