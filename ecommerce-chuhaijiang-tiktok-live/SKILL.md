...
4. Run only the selected entry script, for example: `python scripts/chuhaijiang_live_detail.py '<JSON parameters>' --no-cache` when the script supports that flag.
