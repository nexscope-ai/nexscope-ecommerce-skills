...
Usage:
  ...
  python tiktok_top_selling_products.py '<JSON parameters>' --inline    # force full stdout output
  python tiktok_top_selling_products.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.tiktok-top-selling-products-tiktok_top_selling_products-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/fastmoss/productRankTopSelling'
SLUG = 'ecommerce.tiktok-top-selling-products-tiktok_top_selling_products'
