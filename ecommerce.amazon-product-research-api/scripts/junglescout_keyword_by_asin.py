...
if "--help" in _nexscope_help_sys.argv or "-h" in _nexscope_help_sys.argv:
    print('Usage: python junglescout_keyword_by_asin.py [arguments]')
    raise SystemExit(0)
...
API_PATH = "/api/v1/tools/research/tool-jungle-scout/keywords/by-asin"
SLUG = "nexscope-junglescout-keyword-by-asin"
