...
Call /api/v1/tools/research/chuhaijiang/ad-creative/creatives/detail endpoint.

Usage:
  python chuhaijiang_creative_detail.py '<JSON parameters>'           # Automatic: full small results; save large results to a file + summary
...
def main():
    ...
    if not argv:
        print(
            "Usage: chuhaijiang_creative_detail.py '<JSON parameters>' [--inline] [--no-cache]",
            file=sys.stderr,
        )
        sys.exit(1)
