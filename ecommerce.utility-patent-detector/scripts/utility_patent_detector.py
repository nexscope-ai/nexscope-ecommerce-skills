...
Usage:
  ...
  python utility_patent_detector.py '<JSON parameters>' --inline    # force full stdout output
  python utility_patent_detector.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.utility-patent-detector-utility_patent_detector-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/ruiguan/utilityPatentDetection'
SLUG = 'ecommerce.utility-patent-detector-utility_patent_detector'
