...
Usage:
  ...
  python amazon_reviews.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_reviews.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-reviews-list-amazon_reviews-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/amazon/reviews/list'
SLUG = 'ecommerce-amazon-reviews-list-amazon_reviews'
