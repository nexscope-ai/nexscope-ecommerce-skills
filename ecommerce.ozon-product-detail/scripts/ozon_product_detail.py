#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/mpstats/ozon/productDetail.

Usage:
  python ozon_product_detail.py '<JSON parameters>'
  python ozon_product_detail.py '<JSON parameters>' --inline    # force full stdout output
  python ozon_product_detail.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.ozon-product-detail-ozon_product_detail-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/mpstats/ozon/productDetail'
SLUG = 'ecommerce.ozon-product-detail-ozon_product_detail'
