...
| `NEXSCOPE_AGENT_API_BASE` | runtime configuration |
| `NEXSCOPE_AGENT_USER_API_BASE` | runtime configuration |
| `NEXSCOPE_API_KEY` | secret credential |
| `NEXSCOPE_LOGIN_API_BASE` | runtime configuration |
| `NEXSCOPE_LOGIN_FIXED_UID` | runtime configuration |
