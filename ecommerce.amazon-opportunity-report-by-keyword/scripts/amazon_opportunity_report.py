#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/amazon/opportunity/reportByKeyword.

Usage:
  python amazon_opportunity_report.py '<JSON parameters>'
  python amazon_opportunity_report.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_opportunity_report.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.amazon-opportunity-report-by-keyword-amazon_opportunity_report-<timestamp>.json
...
SLUG = 'ecommerce.amazon-opportunity-report-by-keyword-amazon_opportunity_report'
