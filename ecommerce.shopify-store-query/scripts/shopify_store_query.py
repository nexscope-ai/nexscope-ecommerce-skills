#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/ehunt/shopify/storeQuery.

Usage:
  python shopify_store_query.py '<JSON parameters>'
  python shopify_store_query.py '<JSON parameters>' --inline    # force full stdout output
  python shopify_store_query.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.shopify-store-query-shopify_store_query-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/ehunt/shopify/storeQuery'
SLUG = 'ecommerce.shopify-store-query-shopify_store_query'
