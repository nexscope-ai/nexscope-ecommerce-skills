...
- Compile `scripts/alibaba1688_product_detail.py` with Python.
...
- External Curl did not expose upstream billing headers; backend monitoring `response.headers` supplied array-valued evidence. `X-Cost-Token=1500`, calculated credits `1.5615`, reported `X-Cost-Credit=1`, trace `6807070eba0800d650088368e7ab6f28`. Do not substitute body `costToken`.
