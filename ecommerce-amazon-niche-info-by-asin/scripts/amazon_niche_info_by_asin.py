#!/usr/bin/env python3
"""
NexScope proxy client for /api/v1/tools/research/jiimore/getNicheInfoByAsin.

Usage:
  python amazon_niche_info_by_asin.py '<JSON parameters>'
  python amazon_niche_info_by_asin.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_niche_info_by_asin.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-niche-info-by-asin-amazon_niche_info_by_asin-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/jiimore/getNicheInfoByAsin'
SLUG = 'ecommerce-amazon-niche-info-by-asin-amazon_niche_info_by_asin'
