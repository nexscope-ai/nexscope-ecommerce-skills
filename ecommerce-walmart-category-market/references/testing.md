...
- Compile `scripts/sorftime_walmart_category_market.py` with Python.
...
- External Curl did not expose upstream billing headers; backend monitoring `response.headers` supplied array-valued evidence. `X-Cost-Token=75000`, calculated credits `78.075`, reported `X-Cost-Credit=38`, trace `0e8e1145daba370d6035eb4861452bb0`. Do not substitute body `costToken`.
