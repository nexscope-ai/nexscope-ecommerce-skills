#!/usr/bin/env python3
"""Standard-library proxy client for /ruiguan/detectionPatentDesign.

Usage:
  python ruiguan_detection_patent_design.py '<JSON parameters>'
  python ruiguan_detection_patent_design.py '<JSON parameters>' --inline    # force full stdout output
  python ruiguan_detection_patent_design.py '<JSON parameters>' --no-cache  # skip local cache
"""
import hashlib
import json
import os
...
API_PATH = '/api/v1/tools/research/ruiguan/detectionPatentDesign'
SLUG = 'ecommerce-ruiguan-detection-patent-design'
