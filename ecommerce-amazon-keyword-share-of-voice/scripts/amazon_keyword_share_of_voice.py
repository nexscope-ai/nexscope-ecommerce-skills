...
Usage:
  ...
  python amazon_keyword_share_of_voice.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_keyword_share_of_voice.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce-amazon-keyword-share-of-voice-amazon_keyword_share_of_voice-<timestamp>.json
...
SLUG = 'ecommerce-amazon-keyword-share-of-voice-amazon_keyword_share_of_voice'
