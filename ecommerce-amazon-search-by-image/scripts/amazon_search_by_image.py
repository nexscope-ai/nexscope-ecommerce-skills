#!/usr/bin/env python3
"""Standard-library proxy client for /amazon/searchByImage.

Usage:
  python amazon_search_by_image.py '<JSON parameters>'
  python amazon_search_by_image.py '<JSON parameters>' --inline    # force full stdout output
  python amazon_search_by_image.py '<JSON parameters>' --no-cache  # skip local cache
"""
import hashlib
import json
import os
...
SLUG = 'ecommerce-amazon-search-by-image'
