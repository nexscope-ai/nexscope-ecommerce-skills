...
Usage:
  ...
  python livestream_rank.py '<JSON parameters>' --inline    # force full stdout output
  python livestream_rank.py '<JSON parameters>' --no-cache  # skip local cache

Output strategy (default script behavior):
  - Always writes full response to <cwd>/nexscope/<YYYY-MM-DD>/<session>/data/ecommerce.tiktok-livestream-analytics-livestream_rank-<timestamp>.json
...
API_PATH = '/api/v1/tools/research/kalodata/livestream/rank'
SLUG = 'ecommerce.tiktok-livestream-analytics-livestream_rank'
